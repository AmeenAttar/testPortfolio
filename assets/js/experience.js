...
const exp = [
  {
    ...
    desp: "<li>Worked with cross-functional development teams to build softwares in Security, Crypto & Assest Management</li> <li>Gained expertise in Python and Go, along with system Design.</li> <li>Designed and built critical features, like finance logic for exchange platform, SMTP, IP tables etc.</li>",
  },
  {
    title: "Associate Software Engineer",
    cardImage: "assets/images/experience-page/acc.jpg",
    place: "Accenture",
